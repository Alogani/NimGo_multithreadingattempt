## Source = https://github.com/nim-lang/threading/blob/master/tests/tchannels_simple.nim
## Adapted for GoChannels
...
proc firstWorker() =
    discard chan.send("Hello World!")

# This is another proc to run in a background thread. This proc takes a while
# to send the message since it sleeps for 2 seconds (or 2000 milliseconds).
proc secondWorker() =
    sleep(2000)
    discard chan.send("Another message")
